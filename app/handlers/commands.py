    ...
    if row:
        ...
        if is_admin:
            text = (
                ...
                "/add_user — добавить пользователя (по шаблону)\n"
                "/remove_user &lt;handle&gt; — удалить пользователя\n"
                "/update_handle &lt;old&gt; &lt;new&gt; — обновить handle вручную\n"
                "/update_ratings — обновить рейтинги всех пользователей\n"
                "/list_users — список зарегистрированных\n"
